...
/**
 * Henter ut resultat fra å diffe to dto objekter.
 * Det forventes at begge objektene har samme rot.
 */
public class DiffForKopieringResult {
    ...
    public DiffForKopieringResult(TraverseGraph traverser, TraverseGraph.TraverseResult result1, TraverseGraph.TraverseResult result2) {
