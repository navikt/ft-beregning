...
class KalkulatorMapperTest {
    ...
    private InntektArbeidYtelseGrunnlagDto byggIAY() {
        ...
        iayGrunnlag.medInntekterDto(new InntekterDto(List.of(new UtbetalingDto(InntektskildeType.INNTEKT_BEREGNING, List.of(new UtbetalingsPostDto(periode, InntektspostType.LØNN, BeløpIkkeValidert.fra(1000)))))));
