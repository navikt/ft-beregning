...
class ErTotaltRefusjonskravStørreEnnEllerLikBruttoTest {
    ...
    void skal_gi_true_når_refusjon_overstiger_brutto_og_false_ellers() {
        ...
        var periodisertBg2 = PeriodisertBruttoBeregningsgrunnlag.builder()
            ...
            .leggTilBruttoBeregningsgrunnlag(BruttoBeregningsgrunnlag.builder()
                ...
                .build())
            .build();
        var vurdering1 = ErTotaltRefusjonskravStørreEnnEllerLikBrutto.vurder(List.of(periodisertBg1, periodisertBg2), SKJÆRINGSTIDSPUNKT.plusDays(1));
        var vurdering2 = ErTotaltRefusjonskravStørreEnnEllerLikBrutto.vurder(List.of(periodisertBg1, periodisertBg2), SKJÆRINGSTIDSPUNKT.plusDays(15));
    ...
    @Test
    void skal_gi_false_når_ingen_refusjon() {
        var periodisertBg1 = PeriodisertBruttoBeregningsgrunnlag.builder()
            .medPeriode(Periode.of(SKJÆRINGSTIDSPUNKT, SKJÆRINGSTIDSPUNKT.plusDays(9)))
            .leggTilBruttoBeregningsgrunnlag(BruttoBeregningsgrunnlag.builder()
                .medAktivitetStatus(AktivitetStatusV2.AT)
        ...
        assertThat(vurdering1).isFalse();
        assertThat(vurdering2).isFalse();
    }

    @Test
    void skal_gi_true_når_refusjoner_lik_brutto() {
        var periodisertBg = PeriodisertBruttoBeregningsgrunnlag.builder()
            ...
            .leggTilBruttoBeregningsgrunnlag(BruttoBeregningsgrunnlag.builder()
                ...
                .medArbeidsforhold(Arbeidsforhold.nyttArbeidsforholdHosVirksomhet(ORGNR_2))
                .medBruttoPrÅr(BigDecimal.valueOf(0))
                .medRefusjonPrÅr(BigDecimal.valueOf(300_000))
                .build())
            .build();
        var vurdering = ErTotaltRefusjonskravStørreEnnEllerLikBrutto.vurder(List.of(periodisertBg), SKJÆRINGSTIDSPUNKT.plusDays(1));

        assertThat(vurdering).isTrue();
    }
}
