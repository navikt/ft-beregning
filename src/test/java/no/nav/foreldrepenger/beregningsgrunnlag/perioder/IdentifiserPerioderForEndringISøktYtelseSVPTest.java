...
public class IdentifiserPerioderForEndringISøktYtelseSVPTest {
    ...
    public void fårSplittForFørstePeriode() {
        ...
        // Act
        Set<PeriodeSplittData> periodesplitter = IdentifiserPerioderForEndringISøktYtelseSVP.identifiser(andelGradering);
