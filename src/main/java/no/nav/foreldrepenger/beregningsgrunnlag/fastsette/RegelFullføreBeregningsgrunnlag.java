...
import no.nav.foreldrepenger.beregningsgrunnlag.arbeidstaker.RegelFastsettUtenAvkortingATFL;
import no.nav.foreldrepenger.beregningsgrunnlag.avkorting.RegelFastsettAvkortetBGOver6GNårRefusjonUnder6G;
import no.nav.foreldrepenger.beregningsgrunnlag.fastsette.refusjon.FastsettMaksimalRefusjon;
import no.nav.foreldrepenger.beregningsgrunnlag.fastsette.refusjon.over6g.RegelFastsettAvkortetVedRefusjonOver6G;
import no.nav.foreldrepenger.beregningsgrunnlag.reduksjon.FastsettDagsatsPrAndel;
import no.nav.foreldrepenger.beregningsgrunnlag.reduksjon.ReduserBeregningsgrunnlag;
...
public class RegelFullføreBeregningsgrunnlag extends DynamicRuleService<BeregningsgrunnlagPeriode> {
    ...
    public Specification<BeregningsgrunnlagPeriode> getSpecification() {
        ...
        Specification<BeregningsgrunnlagPeriode> fastsettBeregningsgrunnlag = rs.beregningsRegel(FastsettMaksimalRefusjon.ID, FastsettMaksimalRefusjon.BESKRIVELSE,
