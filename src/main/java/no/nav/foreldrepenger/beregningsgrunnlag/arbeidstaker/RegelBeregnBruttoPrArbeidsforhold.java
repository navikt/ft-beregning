...
import no.nav.foreldrepenger.beregningsgrunnlag.sykepenger.BeregnPrArbeidsforholdNaturalytelseBortfaltForSykepenger;
import no.nav.foreldrepenger.beregningsgrunnlag.sykepenger.SjekkOmBeregningenGjelderSykepenger;
import no.nav.foreldrepenger.beregningsgrunnlag.sykepenger.SjekkOmBortfallAvNaturalYtelseIArbeidsgiverperiodenSykepenger;
