...
import no.nav.foreldrepenger.beregningsgrunnlag.regelmodell.resultat.IdentifisertePeriodeÅrsaker;
...
public class IdentifiserPeriodeÅrsaker {
    ...
    static IdentifisertePeriodeÅrsaker identifiser(PeriodeModell input) {
        ...
        input.getEndringerISøktYtelse().forEach(endringISøktYtelse -> {
            Set<PeriodeSplittData> endringerISøktYtelse = IdentifiserPerioderForEndringISøktYtelseSVP.identifiser(endringISøktYtelse);
