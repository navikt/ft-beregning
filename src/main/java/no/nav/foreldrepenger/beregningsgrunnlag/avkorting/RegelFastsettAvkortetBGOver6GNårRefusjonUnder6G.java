...
public class RegelFastsettAvkortetBGOver6GNårRefusjonUnder6G implements RuleService<BeregningsgrunnlagPeriode> {
    ...
    public Specification<BeregningsgrunnlagPeriode> getSpecification() {
        ...
        Specification<BeregningsgrunnlagPeriode> erTotaltBGFraArbeidforholdStørreEnn6G = rs.beregningHvisRegel(new SjekkOmTotaltBGForArbeidsforholdStørreEnnAntallG(),
