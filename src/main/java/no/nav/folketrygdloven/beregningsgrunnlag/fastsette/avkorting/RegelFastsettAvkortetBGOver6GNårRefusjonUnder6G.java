    ...
    public Specification<BeregningsgrunnlagPeriode> getSpecification() {
        ...
        if (bgpsa != null) {
            ...
            if (!prArbeidsforhold.isEmpty()) {
                Specification<BeregningsgrunnlagPeriode> fastsettUtbetalingsbeløpTilBrukerChain =
                        rs.beregningsRegel(ID, BESKRIVELSE, RegelFastsettUtbetalingsbeløpTilBruker.class, regelmodell, "prArbeidsforhold", prArbeidsforhold, new Beregnet());
