...
public class RegelFastsetteBeregningsgrunnlagForAndelATFLAvATFLSN extends DynamicRuleService<BeregningsgrunnlagPeriode> {

    public static final String ID = "FP_BR_2";

    public RegelFastsetteBeregningsgrunnlagForAndelATFLAvATFLSN(BeregningsgrunnlagPeriode regelmodell) {
        super(regelmodell);
    }
