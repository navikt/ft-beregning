package no.nav.folketrygdloven.beregningsgrunnlag.foreslå.kombinasjon;
...
import no.nav.folketrygdloven.beregningsgrunnlag.foreslå.selvstendig.BeregnGjennomsnittligPGI;
import no.nav.folketrygdloven.beregningsgrunnlag.foreslå.selvstendig.BeregnOppjustertInntekt;
import no.nav.folketrygdloven.beregningsgrunnlag.foreslå.selvstendig.FastsettBeregningsperiode;
import no.nav.folketrygdloven.beregningsgrunnlag.foreslå.selvstendig.FastsettSammenligningsgrunnlagForSN;
import no.nav.folketrygdloven.beregningsgrunnlag.foreslå.selvstendig.SjekkOmBeregninsgrunnlagErBesteberegnet;
import no.nav.folketrygdloven.beregningsgrunnlag.foreslå.selvstendig.SjekkOmBrukerErNyIArbeidslivet;
import no.nav.folketrygdloven.beregningsgrunnlag.foreslå.selvstendig.SjekkOmDifferanseStørreEnn25Prosent;
import no.nav.folketrygdloven.beregningsgrunnlag.foreslå.selvstendig.SjekkOmManueltFastsattBeregningsgrunnlagSN;
import no.nav.folketrygdloven.beregningsgrunnlag.foreslå.selvstendig.SjekkOmVarigEndringIVirksomhetEllerNyoppstartetNæring;
